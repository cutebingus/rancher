...
from .models import Contact, ContactGroup, Gender, Vyrobce, typVozidla
...
class typVozidlaView(ModelView):
    datamodel = SQLAInterface(typVozidla)
    related_views = [VyrobceView]
...
appbuilder.add_view(typVozidlaView, "List typu vozidel", icon="fa-envelope", category="Contacts")
